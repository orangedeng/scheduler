...
$package = Get-ChildItem . -Name *.go -Recurse | Split-Path -Parent | Sort-Object -Unique | Select-String -Pattern "(^\.$|.git|.trash-cache|vendor|bin)" -NotMatch | ForEach-Object { "github.com/rancher/scheduler/$_" }
